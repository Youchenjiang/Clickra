    ...
    public static class Localization
    {
        ...
        private static readonly Dictionary<string, Dictionary<string, string>> Translations = new(StringComparer.OrdinalIgnoreCase)
        {
            [LangTw] = new(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["setting_libreoffice_external_note"] = "這台電腦上的 LibreOffice 不是由 Clickra 安裝，Clickra 不會移除它。如需移除，請使用 Windows 的「應用程式與功能」。",
                ["setting_libreoffice_external_hint"] = "未由 Clickra 安裝：請改用 Windows 的「應用程式與功能」移除。",
            ...
            [LangCn] = new(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["setting_libreoffice_external_note"] = "这台电脑上的 LibreOffice 不是由 Clickra 安装，Clickra 不会移除它。如需移除，请使用 Windows 的“应用和功能”。",
                ["setting_libreoffice_external_hint"] = "非 Clickra 安装：请改用 Windows 的“应用和功能”移除。",
            ...
            [LangEn] = new(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["setting_libreoffice_external_note"] = "This LibreOffice was not installed by Clickra, so Clickra will not remove it. Use Windows Settings > Apps to remove it yourself.",
                ["setting_libreoffice_external_hint"] = "Not installed by Clickra: remove it from Windows Settings > Apps.",
            ...
            [LangJa] = new(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["setting_libreoffice_external_note"] = "このコンピューターの LibreOffice は Clickra がインストールしたものではありません。Clickra は削除しません。削除する場合は Windows の「アプリと機能」をご利用ください。",
                ["setting_libreoffice_external_hint"] = "Clickra 未インストール：Windows の「アプリと機能」から削除してください。",
            ...
            [LangKo] = new(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["setting_libreoffice_external_note"] = "이 컴퓨터의 LibreOffice는 Clickra가 설치한 것이 아니므로 Clickra가 제거하지 않습니다. 제거하려면 Windows의 '앱 및 기능'을 사용하세요.",
                ["setting_libreoffice_external_hint"] = "Clickra가 설치하지 않음: Windows의 '앱 및 기능'에서 제거하세요.",
