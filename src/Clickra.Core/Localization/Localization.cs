    ...
    public static class Localization
    {
        ...
        private static readonly Dictionary<string, Dictionary<string, string>> Translations = new(StringComparer.OrdinalIgnoreCase)
        {
            [LangTw] = new(StringComparer.OrdinalIgnoreCase)
            {
                ...
                [KeyLibreOfficeExternalNote] = "這台電腦上的 LibreOffice 不是由 Clickra 安裝，Clickra 不會移除它。如需移除，請使用 Windows 的「應用程式與功能」。",
                [KeyLibreOfficeExternalHint] = "未由 Clickra 安裝：請改用 Windows 的「應用程式與功能」移除。",
            ...
            [LangCn] = new(StringComparer.OrdinalIgnoreCase)
            {
                ...
                [KeyLibreOfficeExternalNote] = "这台电脑上的 LibreOffice 不是由 Clickra 安装，Clickra 不会移除它。如需移除，请使用 Windows 的“应用和功能”。",
                [KeyLibreOfficeExternalHint] = "非 Clickra 安装：请改用 Windows 的“应用和功能”移除。",
            ...
            [LangEn] = new(StringComparer.OrdinalIgnoreCase)
            {
                ...
                [KeyLibreOfficeExternalNote] = "This LibreOffice was not installed by Clickra, so Clickra will not remove it. Use Windows Settings > Apps to remove it yourself.",
                [KeyLibreOfficeExternalHint] = "Not installed by Clickra: remove it from Windows Settings > Apps.",
            ...
            [LangJa] = new(StringComparer.OrdinalIgnoreCase)
            {
                ...
                [KeyLibreOfficeExternalNote] = "このコンピューターの LibreOffice は Clickra がインストールしたものではありません。Clickra は削除しません。削除する場合は Windows の「アプリと機能」をご利用ください。",
                [KeyLibreOfficeExternalHint] = "Clickra 未インストール：Windows の「アプリと機能」から削除してください。",
            ...
            [LangKo] = new(StringComparer.OrdinalIgnoreCase)
            {
                ...
                [KeyLibreOfficeExternalNote] = "이 컴퓨터의 LibreOffice는 Clickra가 설치한 것이 아니므로 Clickra가 제거하지 않습니다. 제거하려면 Windows의 '앱 및 기능'을 사용하세요.",
                [KeyLibreOfficeExternalHint] = "Clickra가 설치하지 않음: Windows의 '앱 및 기능'에서 제거하세요.",
