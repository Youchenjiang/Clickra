    ...
    public static class Localization
    {
        ...
        private static readonly Dictionary<string, Dictionary<string, string>> Translations = new(StringComparer.OrdinalIgnoreCase)
        {
            [LangTw] = new(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["cmd_merge_img"] = "圖片合併",
                ["cmd_stitch_img"] = "圖片拼接",
                ["cmd_img_to_png"] = "轉成 PNG",
                ["cmd_img_to_jpg"] = "轉成 JPG",
                ["cmd_img_to_webp"] = "轉成 WEBP",
                ["cmd_img_to_heic"] = "轉成 HEIC",
                ["cmd_img_to_gif"] = "轉成 GIF",
                ["tab_convert"] = "轉檔",
                ...
                ["cmd_img_compress"] = "壓縮圖片",
                ["setting_image_compress_title"] = "圖片壓縮設定",
                ["setting_image_compress_desc"] = "自訂圖片壓縮的品質與最大尺寸（長邊）",
                ["setting_image_compress_size"] = "最大尺寸（長邊）",
                ["setting_image_compress_size_original"] = "原始尺寸",
                ["tab_about"] = "關於",
            ...
            [LangCn] = new(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["cmd_merge_img"] = "图片合并",
                ["cmd_stitch_img"] = "图片拼接",
                ["cmd_img_to_png"] = "转换为 PNG",
                ["cmd_img_to_jpg"] = "转换为 JPG",
                ["cmd_img_to_webp"] = "转换为 WEBP",
                ["cmd_img_to_heic"] = "转换为 HEIC",
                ["cmd_img_to_gif"] = "转换为 GIF",
                ["tab_convert"] = "转档",
                ...
                ["cmd_img_compress"] = "压缩图片",
                ["setting_image_compress_title"] = "图片压缩设置",
                ["setting_image_compress_desc"] = "自定义图片压缩的品质与最大尺寸（长边）",
                ["setting_image_compress_size"] = "最大尺寸（长边）",
                ["setting_image_compress_size_original"] = "原始尺寸",
                ["tab_about"] = "关于",
            ...
            [LangEn] = new(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["cmd_img_to_png"] = "Convert to PNG",
                ["cmd_img_to_jpg"] = "Convert to JPG",
                ["cmd_img_to_webp"] = "Convert to WEBP",
                ["cmd_img_to_heic"] = "Convert to HEIC",
                ["cmd_img_to_gif"] = "Convert to GIF",
                ["tab_convert"] = "Convert",
                ...
                ["cmd_img_compress"] = "Compress Images",
                ["setting_image_compress_title"] = "Image Compression Settings",
                ["setting_image_compress_desc"] = "Customize image compression quality and max size (long edge)",
                ["setting_image_compress_size"] = "Max Size (Long Edge)",
                ["setting_image_compress_size_original"] = "Original Size",
                ["tab_about"] = "About",
            ...
            [LangJa] = new(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["cmd_img_to_png"] = "PNG に変換",
                ["cmd_img_to_jpg"] = "JPG に変換",
                ["cmd_img_to_webp"] = "WEBP に変換",
                ["cmd_img_to_heic"] = "HEIC に変換",
                ["cmd_img_to_gif"] = "GIF に変換",
                ...
                ["cmd_img_compress"] = "画像を圧縮",
                ["setting_image_compress_title"] = "画像圧縮設定",
                ["setting_image_compress_desc"] = "画像圧縮の品質と最大サイズ（長辺）をカスタマイズします",
                ["setting_image_compress_size"] = "最大サイズ（長辺）",
                ["setting_image_compress_size_original"] = "元のサイズ",
            ...
            [LangKo] = new(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["cmd_img_to_png"] = "PNG로 변환",
                ["cmd_img_to_jpg"] = "JPG로 변환",
                ["cmd_img_to_webp"] = "WEBP로 변환",
                ["cmd_img_to_heic"] = "HEIC로 변환",
                ["cmd_img_to_gif"] = "GIF로 변환",
                ["tab_convert"] = "변환",
                ...
                ["cmd_img_compress"] = "이미지 압축",
                ["setting_image_compress_title"] = "이미지 압축 설정",
                ["setting_image_compress_desc"] = "이미지 압축 품질과 최대 크기(긴 쪽)를 사용자 정의합니다",
                ["setting_image_compress_size"] = "최대 크기 (긴 쪽)",
                ["setting_image_compress_size_original"] = "원본 크기",
                ["tab_about"] = "정보",
        ...
        private static void RegisterFluentDashboardTranslations()
        {
            var data = new (string Key, string Tw, string Cn, string En, string Ja, string Ko)[]
            {
                ...
                ("fluent_task_parked", "已暫存", "已暂存", "Parked", "一時停止済み", "일시 보류됨"),
                ("fluent_task_parked_waiting", "等待輸入", "等待输入", "Waiting for input", "入力待ち", "입력 대기"),
                ...
                ("fluent_image_size_4k", "4K (3840px)", "4K (3840px)", "4K (3840px)", "4K (3840px)", "4K (3840px)"),
                ("fluent_image_size_fhd", "FHD (1920px)", "FHD (1920px)", "FHD (1920px)", "FHD (1920px)", "FHD (1920px)"),
                ("fluent_image_size_hd", "HD (1280px)", "HD (1280px)", "HD (1280px)", "HD (1280px)", "HD (1280px)"),
