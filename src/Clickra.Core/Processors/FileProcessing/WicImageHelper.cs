...
public static class WicImageHelper
{
    ...
    /// <summary>
    /// Encodes raw BGRA8 pixels into a HEIC/HEIF file at the target output path.
    /// </summary>
    private static void EncodePixelsToHeic(byte[] pixels, uint width, uint height, double dpiX, double dpiY, string outputPath, long quality)
    {
