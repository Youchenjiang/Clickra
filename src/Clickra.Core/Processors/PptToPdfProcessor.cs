...
{
    public class PptToPdfProcessor : SingleFileProcessorBase
    {
        ...
        {
            PowerShellInteropHelper.ExportOfficeToPdf("PowerPoint", fullPath, targetOutputPath, fileIndex, totalFiles, onProgress, cancellationToken);
        }
    }
}
