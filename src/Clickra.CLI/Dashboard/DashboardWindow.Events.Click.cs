...
namespace Clickra.UI
{
    public static partial class DashboardWindow
    {
        ...
        static void HandleLButtonDown(IntPtr hwnd, IntPtr w, IntPtr l)
        {
            ...
            if (HandleScrollbarClick(hwnd, mouseX, mouseY, logW, logH, contentH, showV, showH, sidebarW)) return;
        ...
        static bool HandleScrollbarClick(IntPtr hwnd, int mouseX, int mouseY, float logW, float logH, float contentH, bool showV, bool showH, float sidebarW)
        {
