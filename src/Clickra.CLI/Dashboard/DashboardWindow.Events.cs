    ...
    public static partial class DashboardWindow
    {
        ...
        static IntPtr WndProc(IntPtr hwnd, uint msg, IntPtr w, IntPtr l)
        {
            switch (msg)
            {
                ...
                case 0x0200: return HandleMouseMove(hwnd, w, l); // WM_MOUSEMOVE
                ...
                case 0x0020: // WM_SETCURSOR
                    {
                        IntPtr? cursorResult = HandleSetCursor(hwnd, w, l);
        ...
        static IntPtr HandleMouseMove(IntPtr hwnd, IntPtr w, IntPtr l)
        {
        ...
        static IntPtr? HandleSetCursor(IntPtr hwnd, IntPtr w, IntPtr l)
        {
            var pt = new Point();
